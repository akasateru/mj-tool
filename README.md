...
**本番**: [https://mj-tool.vercel.app/](https://mj-tool.vercel.app/)（Vercel）。フロントは Vercel、API は Render（DB は Supabase）を想定しています。手順は [DEPLOY_RENDER.md](./DEPLOY_RENDER.md)（API）を参照。
